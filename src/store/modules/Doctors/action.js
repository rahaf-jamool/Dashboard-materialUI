...
export const loadDoctors = ({ commit }) => {
  axios
    .get(`http://doctors.e-dalely.com/public/api/doctor/get`)
    .then((res) => {
...
export const loadDoctor = ({ commit }, DoctorID) => {
  axios
    .get(`http://doctors.e-dalely.com/public/api/doctor/getById/${DoctorID}`)
    .then((res) => {
...
export const loadDoctorTrashed = ({ commit }) => {
  axios
    .get(`http://doctors.e-dalely.com/public/api/doctor/getTrashed`)
    .then((res) => {
