  ...
  <form>
    <md-card>
      <md-card-header :data-background-color="'green'">
        ...
        <div class="new_product"> <router-link :to="`/Store/${this.$route.params.id}/NewProduct`" ><button><i class="fa fa-plus"></i>
      ...
      <md-card-content>
        ...
        <div class="md-layout">
          ...
          <!-- loop products -->
        <StoreProd  v-for="items in store.product.slice(0,10)"
                    :key="items.pr"
                    :id="items.id"
                    :name="items.name"
                    :image="items.image"
